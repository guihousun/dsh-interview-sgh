...
test('业务工具描述不再要求状态机恢复和 nextAction 工具链', () => {
  ...
  assert.match(fixture.tools.interview_question.description, /背八股（bagu）/)
  assert.match(fixture.tools.interview_question.description, /模拟面试（mock）/)
  assert.match(fixture.tools.interview_question.description, /场景题（scenario）/)
  assert.match(fixture.tools.interview_question.description, /刷力扣（leetcode）/)
  assert.match(fixture.tools.interview_explanation.description, /config\.language/)
